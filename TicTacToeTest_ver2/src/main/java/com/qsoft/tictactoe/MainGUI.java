...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$()
    {
        ...
        panel4.setLayout(new FormLayout("fill:50px:grow,left:4dlu:noGrow,fill:d:noGrow", "center:d:noGrow,top:4dlu:noGrow,center:max(d;4px):noGrow"));
        panel2.add(panel4, cc.xy(5, 1));
        btStart = new JButton();
        btStart.setLabel("Start");
        btStart.setName("btStart");
        btStart.setText("Start");
        panel4.add(btStart, cc.xy(3, 1));
        btStop = new JButton();
        btStop.setLabel("Stop");
        btStop.setName("btStop");
        btStop.setText("Stop");
        panel4.add(btStop, cc.xy(3, 3));
